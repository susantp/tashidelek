...
@if(request()->segment(2) == "home")
    <!-- Page level plugins -->
    <script src="{{secure_asset('storage/vendor/chart.js/Chart.min.js')}}"></script>

    <!-- Page level custom scripts -->
    <script src="{{secure_asset('storage/js/demo/chart-area-demo.js')}}"></script>
    <script src="{{secure_asset('storage/js/demo/chart-pie-demo.js')}}"></script>
@endif
